//Параметры (в строгой последовательности)
// ИмяРегистрационнойГруппы - Наименование регистрационной группы
// ВидДисконтнойКарты - Вид дисконтной карты (Ссылка на справочник "Виды дисконтных карт"
// ИмяПоляРеференснойСсылки - Имя поля в шаблоне электронной карты с референсной ссылкой
// ПрефиксШККарты - Префикс штрихкода карты
// АдресАнкеты - Адрес анкеты
// ШаблонКарты - Используемый шаблон электронных карта (Ссылка на справочник "Шаблоны электронных карт")
// БонуснаяПрограмма - Используемая бонусная программа (Ссылка на справочник "Бонусные программы")
