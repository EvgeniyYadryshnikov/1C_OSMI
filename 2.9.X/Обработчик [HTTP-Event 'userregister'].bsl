...
Функция ПолучитьИнформационнуюКарту(КодОСМИ)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ ПЕРВЫЕ 1
	                      |	ПИТ_СоответствиеКодовКартОСМИ.ИнформационнаяКарта
	                      |ИЗ
	                      |	РегистрСведений.ПИТ_СоответствиеКодовКартОСМИ КАК ПИТ_СоответствиеКодовКартОСМИ
	                      |ГДЕ
	                      |	НЕ ПИТ_СоответствиеКодовКартОСМИ.ИнформационнаяКарта.ПометкаУдаления
	                      |	И НЕ ПИТ_СоответствиеКодовКартОСМИ.ИнформационнаяКарта.ЭтоГруппа
	                      |	И ПИТ_СоответствиеКодовКартОСМИ.КодОСМИ = &КодОСМИ");
...
Функция ПолучитьГруппуФизическихЛиц(Знач КодОСМИ)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ ПЕРВЫЕ 1
	                      |	ПИТ_ГруппыФизическихЛицПоДиапазонамКодовАвтоРегистрации.ГруппаФизическихЛиц
	                      |ИЗ
	                      |	РегистрСведений.ПИТ_ГруппыФизическихЛицПоДиапазонамКодовАвтоРегистрации КАК ПИТ_ГруппыФизическихЛицПоДиапазонамКодовАвтоРегистрации
	                      |ГДЕ
	                      |	ПИТ_ГруппыФизическихЛицПоДиапазонамКодовАвтоРегистрации.ДиапазонС <= &КодОСМИ
